...
AR_LESSON_NOTE = ("محتوى هذا الدرس متاح باللغة الإنجليزية. واجهة المنصة "
                  "وصفحتا الرسالة والمسارات المهنية متاحة بالعربية كاملة.")
AR_PAGE_NOTE = ("محتوى هذه الصفحة متاح باللغة الإنجليزية — واجهة المنصة "
                "متاحة بالعربية بالكامل.")
